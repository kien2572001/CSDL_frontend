          ...
          {this.props.isLoggedIn ? (
            <>
              <div
                ...
                onMouseOver={() => this.hanldeShowUserOption()}
                onMouseOut={() => this.handleOnMouseOut()}
              >
                <div className='dropdown-btn'>
                  <img
                    src='https://pickbazar-react-rest.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fimage%2Fsrc%2Fassets%2Fplaceholders%2Favatar.2a4ed68cad8ebe21317b04e155b6b245.svg&w=1920&q=75'
                    alt='Avatar'
                  />
                </div>
                <div
          ...
          >
            {!this.state.isShowModalForgotPassword ? (
                    ...
                    <div className='login-register-user '>
                      ...
                      <a
                        onClick={() =>
                          this.setState({
                            isShowModalRegister:
                              !this.state.isShowModalRegister,
                          })
                        }
                      >
                        Register
              ...
              <div className='container-forgotPassword'>
                ...
                <h3 className='forgotPassword__header'>Forget Password?</h3>
                ...
                <div className='forgotPassword__footer'>
                  <div className='forgotPassword__footer-login'>
                    <span>Back to&nbsp;</span>
                    <a onClick={() => this.handleShowModalForgotPassword()}>
                      Login
                    </a>
                  </div>
                </div>
